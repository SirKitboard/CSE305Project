    ...
    <div class="container template">
        ...
        <div id="navBar" class="col s12">
          <ul class="tabs z-depth-1">
            ...
            <li class="tab col s3"><a href="#employeesTab">Employees</a></li>
...
<script type="text/babel" src="${request.static_url('myapp:static/js/employeeDashboard/employees.jsx')}"></script>
